...
HRESULT CFloor::Load(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\FLOOR\\field002.jpg", &m_pTexture[1]);	//	コンクリ床
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\FLOOR\\sewfloor.jpg", &m_pTexture[2]);	//	海
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\FLOOR\\floor003.jpg", &m_pTexture[3]);	//	土
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\FLOOR\\floor004.jpg", &m_pTexture[4]);	//	コンクリート
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\WALL\\wall006.jpg", &m_pTexture[5]);		//	室内の壁
