...
void InitScore(void)
{
	...
	//位置
	g_posScore = D3DXVECTOR3(920, 40, 0.0f);
	...
	{
		//頂点設定
		pVtx[0].pos = D3DXVECTOR3(g_posScore.x - 20 , g_posScore.y - 20, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(g_posScore.x + 20, g_posScore.y - 20, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(g_posScore.x - 20, g_posScore.y + 20, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(g_posScore.x + 20, g_posScore.y + 20, 0.0f);
		//1.0fで固定
		pVtx[0].rhw = 1.0f;
		pVtx[1].rhw = 1.0f;
		pVtx[2].rhw = 1.0f;
