...
#define	TEXTURE_GAME005 	"data\\TEXTURE\\UI\\GAME\\aizu.png"					// 合図
...
#define	TEXTURE_RANKING005 	"data\\TEXTURE\\UI\\RANKING\\raking005.png"			// 順位
#define	TEXTURE_RANKING006 	"data\\TEXTURE\\UI\\RANKING\\myrank.png"			// 自己ベスト
...
HRESULT CUI::Load(CManager::MODE mode)
{
	...
	case CManager::MODE_GAME://	ゲーム	-----------------------------------------------------------------------------
		...
		D3DXCreateTextureFromFile(pDevice, TEXTURE_GAME005, &m_pTexture[13]);	// 順位005
	...
	case CManager::MODE_RANKING://	ランキング	-------------------------------------------------------------------------
		...
		D3DXCreateTextureFromFile(pDevice, TEXTURE_RANKING006, &m_pTexture[14]);	// 自己ランク
		break;
	}
...
void CUI::CreateMode(CManager::MODE mode)
{
	...
	case CManager::MODE_GAME://	ゲーム	-----------------------------------------------------------------------------
		...
		// 撃て
		CUI::Create
		(D3DXVECTOR3(1000.0f, 150.0f, 0.0f), D3DXVECTOR3(0, 200, 0.0f),
			D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0), D3DXVECTOR2(1.0f, 1.0f), 13);
		break;
	case CManager::MODE_RANKING://	ランキング	-------------------------------------------------------------------------
		...
		// 順位 3位
		CUI::Create
		(D3DXVECTOR3(700.0f, 440.0f, 0.0f), D3DXVECTOR3(50.0f, 40, 0.0f),
			D3DXCOLOR(0.7f, 0.5f, 0.0f, 1.0), D3DXVECTOR2(1.0f, 1.0f), 10);

		// 順位 4位
		CUI::Create
		(D3DXVECTOR3(700.0f, 540.0f, 0.0f), D3DXVECTOR3(50.0f, 40, 0.0f),
			D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0), D3DXVECTOR2(1.0f, 1.0f), 11);

		// 順位 5位
		CUI::Create
		(D3DXVECTOR3(700.0f, 640.0f, 0.0f), D3DXVECTOR3(50.0f, 40, 0.0f),
			D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0), D3DXVECTOR2(1.0f, 1.0f), 12);

		// 自己ベスト
		CUI::Create
		(D3DXVECTOR3(150.0f, 500.0f, 0.0f), D3DXVECTOR3(100.0f, 50, 0.0f),
			D3DXCOLOR(1.0f, 1.0f, 1.0f, 1.0), D3DXVECTOR2(1.0f, 1.0f), 14);
		break;
	}
}
