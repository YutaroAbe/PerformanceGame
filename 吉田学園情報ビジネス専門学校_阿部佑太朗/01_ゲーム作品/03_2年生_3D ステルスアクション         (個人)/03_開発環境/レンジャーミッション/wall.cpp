...
HRESULT CWall::Load(void)
{
	...
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\WALL\\wall001.png", &m_pTexture[1]);		//	壁網
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\WALL\\wall002.jpg", &m_pTexture[2]);		//	壁薄暗い
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\WALL\\wall003.png", &m_pTexture[3]);		//	船取っ手部分
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\WALL\\wall004.jpg", &m_pTexture[4]);		//	機械的な壁
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\WALL\\wall005.jpg", &m_pTexture[5]);		//	機械的な壁
	D3DXCreateTextureFromFile(pDevice, "data\\TEXTURE\\WALL\\wall006.jpg", &m_pTexture[6]);		//	室内の壁
