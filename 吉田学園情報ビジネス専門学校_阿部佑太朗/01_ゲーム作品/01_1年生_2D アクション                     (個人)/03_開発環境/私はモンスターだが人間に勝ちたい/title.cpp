...
#define TITLE_TEXTURENAMRE2 "data/TEXTURE/Press000.png" //読み込むテクスチャ
...
void InitTitle(void)
{
	...
	g_PosPressEnter = D3DXVECTOR3(600, 500, 0.0f);//プレスエンター
	g_aTPress = 0;
	g_aTitleCounter = 0;
	...
	pVtx[2].pos = D3DXVECTOR3(g_PosTitle.x - 400, g_PosTitle.y + 100, 0.0f);		 //左上
	pVtx[3].pos = D3DXVECTOR3(g_PosTitle.x + 400, g_PosTitle.y + 100, 0.0f);		 //左下
																					 //RHW
	pVtx[0].rhw = 1.0f;
	pVtx[1].rhw = 1.0f;
	pVtx[2].rhw = 1.0f;
