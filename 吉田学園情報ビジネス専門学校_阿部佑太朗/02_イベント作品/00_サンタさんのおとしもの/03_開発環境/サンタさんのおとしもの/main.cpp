...
#define WINDOW_NAME		"サンタさんのおとしもの"	// ウインドウの名前(キャプション名)
...
void SetMode(MODE mode)
{
	...
	case MODE_TITLE:
		UninitTitle();
		StopSound(SOUND_LABEL_BGM002_TITLE);
		break;
	case MODE_SELECT:
		UninitSelectmode();
		StopSound(SOUND_LABEL_BGM003_MODESELECT);
		break;
	case MODE_RANK:
		UninitRanking();
		StopSound(SOUND_LABEL_BGM004_RANKING);
		break;
	case MODE_GAME:
		UninitGame();
		StopSound(SOUND_LABEL_BGM001_GAME);
		break;
	case MODE_TUTO:
		UninitTutorial();
		StopSound(SOUND_LABEL_BGM005_TUTORIAL);
		break;
	case MODE_RESULT:
		UninitResult();
		StopSound(SOUND_LABEL_BGM006_RESULT);
		break;
	}
	...
	case MODE_TITLE:
		InitTitle();
		PlaySound(SOUND_LABEL_BGM002_TITLE);
		break;
	case MODE_SELECT:
		InitSelectmode();
		PlaySound(SOUND_LABEL_BGM003_MODESELECT);
		break;
	case MODE_RANK:
		InitRanking();
		PlaySound(SOUND_LABEL_BGM004_RANKING);
		break;
	case MODE_GAME:
		InitGame();
		PlaySound(SOUND_LABEL_BGM001_GAME);
		break;
	case MODE_TUTO:
		InitTutorial();
		PlaySound(SOUND_LABEL_BGM005_TUTORIAL);
		break;
	case MODE_RESULT:
		InitResult();
		PlaySound(SOUND_LABEL_BGM006_RESULT);
		break;
	}
	g_Mode = mode;
}
