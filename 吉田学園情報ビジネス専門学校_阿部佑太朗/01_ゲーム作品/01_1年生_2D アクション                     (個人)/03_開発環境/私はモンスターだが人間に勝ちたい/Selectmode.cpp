...
#define BG_TEXTURENAMRE2 "data/TEXTURE/sel003.png" //読み込むテクスチャ
#define BG_TEXTURENAMRE3 "data/TEXTURE/sel000.png" //読み込むテクスチャ
#define BG_TEXTURENAMRE4 "data/TEXTURE/sel001.png" //読み込むテクスチャ
#define BG_TEXTURENAMRE5 "data/TEXTURE/sel004.png" //読み込むテクスチャ
...
#define BG_TEXTURENAMRE9  "data/TEXTURE/4.png" //読み込むテクスチャ
#define BG_TEXTURENAMRE10  "data/TEXTURE/1.png" //読み込むテクスチャ
#define BG_TEXTURENAMRE11 "data/TEXTURE/2.png" //読み込むテクスチャ
#define BG_TEXTURENAMRE12  "data/TEXTURE/3.png" //読み込むテクスチャ
...
void UpdateSelectmode(void)
{
	...
	if (GetKeyboardTrigger(DIK_W) == true)//----Wボタン押してる場合
	{
		...
		g_pVtxBuffSelectmode->Lock(0, 0, (void**)&pVtx, 0);
		//カラーW
		pVtx[32].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		pVtx[33].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		pVtx[34].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		pVtx[35].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		//頂点バッファアンロックする
		g_pVtxBuffSelectmode->Unlock();
	}
	...
	if (GetKeyboardTrigger(DIK_S) == true)//----Wボタン押してる場合
	{
		...
		g_pVtxBuffSelectmode->Lock(0, 0, (void**)&pVtx, 0);
		//カラーW
		pVtx[36].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		pVtx[37].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		pVtx[38].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		pVtx[39].col = D3DCOLOR_RGBA(120 + 120, 120, 120, 120 + 120);
		//頂点バッファアンロックする
		g_pVtxBuffSelectmode->Unlock();
	}
